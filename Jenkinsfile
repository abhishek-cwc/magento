pipeline {
  ...
  stages {
    ...
    stage('SonarQube Scan') {
  	...
  	-Dsonar.php.coverage.reportPaths=/var/lib/jenkins/workspace/firstp/app/code/build/reports/coverage.xml \
  	-Dsonar.php.tests.reportPath=/var/lib/jenkins/workspace/firstp/app/code/build/reports/exceution-reports.xml \
